...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('finishes', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(Race::class)->constrained()->onDelete('cascade');
            ...
            $table->foreign('driver_3_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_4_id');
            $table->foreign('driver_4_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_5_id');
            $table->foreign('driver_5_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_6_id');
            $table->foreign('driver_6_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_7_id');
            $table->foreign('driver_7_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_8_id');
            $table->foreign('driver_8_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_9_id');
            $table->foreign('driver_9_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->unsignedBigInteger('driver_10_id');
            $table->foreign('driver_10_id')->references('id')->on('drivers')->onDelete('cascade');
            $table->timestamps();
        });
    }
